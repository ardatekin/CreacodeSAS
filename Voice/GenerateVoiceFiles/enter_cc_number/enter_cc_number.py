...
# ----------------------
PROMPTS = {
    "english": ("en", "Please enter the last six digits of your credit card."),
    "german": ("de", "Bitte geben Sie die letzten sechs Ziffern Ihrer Kreditkarte ein."),
    "french": ("fr", "Veuillez saisir les six derniers chiffres de votre carte de crédit."),
    "italian": ("it", "Inserisci le ultime sei cifre della tua carta di credito."),
    "turkish": ("tr", "Lütfen kredi kartınızın son altı hanesini giriniz."),
    "spanish": ("es", "Por favor, introduzca los últimos seis dígitos de su tarjeta de crédito."),
    "russian": ("ru", "Пожалуйста, введите последние шесть цифр вашей кредитной карты."),
}
...
def generate_prompt(lang, code, text):
    print(f"\n🔊 Generating {lang.title()} enter_cc_number prompt...")
    ...
    # PCM output
    pcm_file = os.path.join(lang_dir, "PCM", "enter_cc_number.wav")
    ...
    print(f"🏁 {lang.title()} enter_cc_number prompt generation complete")
