...
# Configuration
# ----------------------
SCRIPT_NAME = "too_many_wrong_entry"

PROMPTS = {
    "english": ("en", "Too many invalid entries."),
    "german": ("de", "Zu viele ungültige Eingaben."),
    "french": ("fr", "Trop de saisies invalides."),
    "italian": ("it", "Troppi inserimenti non validi."),
    "turkish": ("tr", "Çok fazla hatalı giriş yaptınız."),
    "spanish": ("es", "Demasiadas entradas no válidas."),
    "russian": ("ru", "Слишком много неверных вводов."),
}
