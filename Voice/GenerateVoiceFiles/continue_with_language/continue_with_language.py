...
# ----------------------
PROMPTS = {
    "english": ("en", "Continuing in English."),
    "german": ("de", "Es wird auf Deutsch fortgefahren."),
    "french": ("fr", "Poursuite en français."),
    "italian": ("it", "Si continua in italiano."),
    "turkish": ("tr", "Türkçe ile devam ediliyor."),
    "spanish": ("es", "Continuando en español."),
    "russian": ("ru", "Продолжаем на русском."),
}
...
def generate_prompt(lang, code, text):
    print(f"\n🔊 Generating {lang.title()} continue_with_language prompt...")
    ...
    # PCM output
    pcm_file = os.path.join(lang_dir, "PCM", "continue_with_language.wav")
    ...
    print(f"🏁 {lang.title()} continue_with_language prompt generation complete")
