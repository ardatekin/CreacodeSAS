...
# Configuration
# ----------------------
SCRIPT_NAME = "enter_cc_password"

PROMPTS = {
    "english": ("en", "Please enter your four-digit credit card password."),
    "german": ("de", "Bitte geben Sie Ihr vierstelliges Kreditkartenpasswort ein."),
    "french": ("fr", "Veuillez entrer le mot de passe à quatre chiffres de votre carte de crédit."),
    "italian": ("it", "Inserisci la password a quattro cifre della tua carta di credito."),
    "turkish": ("tr", "Lütfen dört haneli kredi kartı şifrenizi giriniz."),
    "spanish": ("es", "Por favor, introduzca la contraseña de cuatro dígitos de su tarjeta de crédito."),
    "russian": ("ru", "Пожалуйста, введите четырехзначный пароль вашей кредитной карты."),
}
