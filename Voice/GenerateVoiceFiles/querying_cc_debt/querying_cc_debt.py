...
# Configuration
# ----------------------
SCRIPT_NAME = "querying_cc_debt"

PROMPTS = {
    "english": ("en", "Your outstanding credit card balance is being retrieved."),
    "german": ("de", "Ihr ausstehender Kreditkartensaldo wird abgerufen."),
    "french": ("fr", "Votre solde de carte de crédit impayé est en cours de récupération."),
    "italian": ("it", "Il saldo residuo della tua carta di credito è in fase di recupero."),
    "turkish": ("tr", "Kredi kartınızın güncel borç bilgisi sorgulanıyor."),
    "spanish": ("es", "Se está recuperando el saldo pendiente de su tarjeta de crédito."),
    "russian": ("ru", "Ваш непогашенный остаток по кредитной карте запрашивается."),
}
